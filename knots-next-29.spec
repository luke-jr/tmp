...
TM	34093 fix_freebsd15_netlink_warn			d86dcf6fad1	last=c1361fc42dd vasild/fix_nlmsg_ok_compilation_fbsd15
	(CHECK-LAST)	last=490cd874a40 origin-pull/34680/head^  # 29.x backport
	k246  fix_boost1.73compat-29				2579d97f6bf
		# https://github.com/bitcoin/bitcoin/issues/34101
	34462 fix_bsd_batchprio-26					f7248c82d88
	...
	-     revert_core_boost1.91fix				313e34c515a
	-     compatfix_boost_1.91-28				4888121f9c5
		# Similar to #35175 (but without the regression)
# SYSLIBS:
	2241  sys_leveldb							807eb8e8ade	last=bd2be933f26 sys_leveldb-30
		# Related: #32447
		# If https://github.com/bitcoin-core/leveldb-subtree/pull/52 is merged, this should possibly be adapted
	5416  sys_libsecp256k1						55aa61d6f0a	last=0a4a73bb830 sys_libsecp256k1-30
	# TODO: sys_crc32c ??
	# Hopelessly diverged? -     sys_univalue					5a04090dfe1
	# Hopelessly diverged? 7485  sys_univalue_def				30111aa138c
	n/a   rm_minisketch-29+syslibs				4eb42574108	last=0fd60441475 rm_minisketch-30+syslibs
		# Implicitly includes most of #18818
		#30.xTODO# sys_libminisketch
	15155 test_external_bcli					dbd8d51ee91	last=8f25a48c298 test_external_bcli-30
	30997 qt5qt6-29								baef0a0ec23	last=65319c41ff1 compat_qt5-30
		# Includes parts of gui#861 whitslack/qt6
	g899  qt6compat_invalidateFilter-23			49eef8ac8be
...
# TESTS:
	...
	-     lint_relaxer-29+knots					a2adbe8e9ff
	-     nowarn_unreachable-code				2be2554e62f
...
NM	-     ci_gha_makejobs_8						c5f86dea3c3
	...
	33639 docker_no_cache_gha-29.4				f56745e56a9
	33990 qa_rpc_startingheight-28				246f8bb0793	last=52f96cc235d theStack/202512-test-announced_starting_height
	34185 qafix_pruning_wo_wallet-25			851985f6a79	last=8fb5e5f41dd brunoerg/2025-12-test-pruning-wout-wallet
	...
	n/a   fix_dbcrash_timeout_pr34589part-0.16	a4944f26bee
		# Part of #34589
	34622 qafix_debuglog_races_pr34622-29.3+k	0fac07777a3
...
# FIXES:
	33433 qafix_rpc_bind_nonloopback_unavail	33ef9044651
	13789 asm_bypass_cxxflags					a4ad5ca46c8
	(CHECK-LAST)	last=6878dd8f1ab origin-pull-k/309/head
		# + knots#309
	32217 fix_gitdir_foreign					91d5e3f67db
		# Was part of #18902
	#30.xTODO# Revert #32220 (cmake: Get rid of undocumented BITCOIN_GENBUILD_NO_GIT environment variable)
	-     relsrc_embed_tagname-29+knots			77f9bf1b1ae	last=607a4fddf61 relsrc_embed_tagname-30+knots
		# Was part of #18902
	18427 2020mingwthrd-mini					6766c0dbd34	 # Latest code now
	18490 bugfix_symcheck_pe_case				ce6d3b55e61	last=63b637b3c34 bugfix_symcheck_pe_case-30
	14968 http_bind_error						49f70ce2096	last=7b5e4001f9 laanwj/2018_12_http_bind_error
	-     http_bind_error+extra					cb862fc1482	last=33dcd1b043b http_bind_error+extra-30
	 ...
	 9524  rpc_pruneblkchain0					e63b81841a0	last=88883ae13d
	10731 log_more_uacomment					d65c8bff8c9
	29614 bufferedfile_fclose					fcadbebdd73
	14485 fadvise-29+knots						7bb1f1a9e3b	last=8fe39e158f9 fadvise-30+knots
		# Was #12491
	# Needs review: 21313 fsync_dir_pt2 after PR submitted & reviewed & tested
	# Needs bugfix: -     fsync_dir_win
	-     rpcarg_type_per_name					df7e3320f50
	-     fix_rpc_arg_multiname					5f23fc4ad4c
	-     bugfix_rpc_getbalance_hacky			1f44c1f898e	last=d5ac1a2b0b1 bugfix_rpc_getbalance_hacky-30
	# FIX THE BELOW:
	...
	18194 bugfix_gui_edit_sendaddr-mini			61fb0cf191a	last=0a44e08992f bugfix_gui_edit_sendaddr
		# NOTE: -mini is just missing the last commit :)
	# Needs re-concept: 19358 # net: Make sure we do not override proxy settings in hidden service.
	19419 listwalletdir_skip_data				01b0c2f9ee8	last=3f9cc0cd736 Saibato/wallet_351
	...
	g152  gui_notify_setup_bg					eb99b0e2a32
	-     bugfix_gui_drop_abc_confusing_hack	0f44c0249df
	...
	g236  gui_init_walleterror_cont				69be1c89809
	-     rpc_addconnection_mainnet				00f9e18997c
	32343 subproc_closefds						94b6ab1cf87
		# Was #30756
		# Replaces #22417 (Boost::Process variant)
	# Needs review: 22665 darosior:rbf_optin_nomempool
	23027 bugfix_util_test_config				29d9bf2dcb4
	...
	g506  qt_qrcode_sizefixes					760dbf84a92
	# Needs review: 24034 -  # p2p: delete anchors.dat after trying to connect to that peers
	24066 -										f38ddb94330	last=89cb2b6d91e  # contrib/init: (OpenRC) use -daemonwait to wait for startup completion
	-     openrc_from_gentoo					4f70de90dd1
	...
	24479 bugfix_settings_numberval				218864fa05b
	...
	24718 fix_rpc_docs_pr24718-28+knots			f9903384be0	last=68a041dd12b
	...
	g595  qt_handle_autostart_errors-0.15		0e01c695256	last=d932157eb79
		# Upstream mruddy-g/issue_24953 repo got deleted :/
	-   gui_psbt_error_msgbox					712cf8290b9	last=87c42be2d70 gui_psbt_error_msgbox-30
	...
	32358 fix_subprocess_pr32358-28				9cabb3fd956
	32567 fix_subprocess_pr32567-28				61c1f43949e	last=e63a7034f03 hebasto/250520-subprocess-backports
	29868 hww_windows-29						04092839928	last=3a18075aedd hebasto/240414-win-subprocess
	...
	g633  -										b111dc4f647	last=5fde8fbe085  # qt: Fix shortcut ambiguities
	# Meh: 25854 -  # tracing.md trivial English fixes
	g662  qt_fix_txview_202209					09ee8b321dd	last=7304c97b1af qt_fix_txview_202209-30
		# Includes gui#368
	...
	g677 fix_qt_peers_na						9c8c63edd19
	...
	g684  qt_reqs_multiselect_pr684-28+knots	51043a5c25d	last=a6f567590b7
	...
	-     qafix_assert_debug_log_create			5ab1eadd6b7
	-     acceptstalefeeestimates_mainnet_opt	888e99a2956
	...
	27814 forbid_nohelp-29						0a3a711b93c	last=bfc2bb6a270
	...
	28029 fix_zmq_errhandling_202307-mini		1c5af5bca47	last=ba28af94bd5 fix_zmq_errhandling_202307
		# Just diff-minimised
	28055 fix_getblockfrompeer_rereq_err		bd8b4cd80b7
	...
	28345 fix_bytespersigop_checks-mini			c62edf573b9	last=6f627727739 fix_bytespersigop_checks
	...
	28616 Sjors/2023/10/assume-unconfirmed		ba87c6afcbf	last=3e281590c7d  # assumeutxo_unconfirmed_ux_Sjors-28
	(CHECK-LAST)	last=202163a6778 assumeutxo_unconfirmed_ux_Sjors-30
	-     assumeutxo_unconfirmed_ux-29			e9db63963f5	last=ee1bfd9dada assumeutxo_unconfirmed_ux-30
	-     qt_recomm_confirms-0.9				91fe0b49460
	...
	-     fix_keep_notmy_cookie					421d67865c7	last=61678a031e1 fix_keep_notmy_cookie-30
	...
	28944 rpc_sendall_anti_fee_sniping-28		ecc5de7a0ed	last=aac0b6dd79b ishaanam/sendall_anti_fee_sniping
		# + #33118
	# Needs review: 35019 HouseOfHufflepuff/rpc/uniform-locktime-anti-fee-sniping
	-     rpc_walletcfpsbt_antifeesniping-28+k	626c426660d	last=6fc07948bdd rpc_walletcfpsbt_antifeesniping-30+k
	(CHECK-LAST)	last=113ba106273 Sjors/2025/07/locktime
		# Includes tests from #32892
	29141 fix_rpcauth_blank						3b1da8c8718
	...
	29175 -										ebebd2680bd	last=be8ae64b82e  # rpc: validate fee estimation mode case insensitive (fix_rpc_estmode_unset_case-24)
	...
	31551 bulk_block_rw-29+knots				662fc572e9f
		# Optimisation, not fix - but simplifies #29307
	29307 AutoFile_error_check-29+knots			3b06b3c6f31	last=c10e382d2a3 vasild/AutoFile_error_check
	...
	29640 fix_tiebreak_on_disk-26				17526c4406e	last=0465574c127 sr-gi/202403-block-tiebreak
	...
	29678 fix_init_lowdisk_warning_reqd-29		b7edf0f8459	last=b1117e5a716 fix_init_lowdisk_warning_reqd
	...
	-     fix_rpc_warnings_all-28				b3cde672728
	g815  fix_qt_privacy_before_open-23			372642f5025	last=0dc337f73d0
	...
	-     jonatack/2024-05-fix-cjdns-detection-in-AddNode	736efc7dc57	last=be4541abe59 jonatack/2024-05-fix-cjdns-detection-in-AddNode  # fix_cjdns_addnode_detect2-27+knots
	...
	30221 fix_wallet_bestblock-29.3				64cfb92f9e8
		# aka knots#290
		# +#32281 +#32580 +#32345
	...
	-     detect_clang_bug96267					8dced3925b6	last=ea6ae8d271e detect_clang_bug96267-30
	...
	31275 fix_rpc_example_quoting_pr31275-24	91f9a40f07a	last=7e93e292598
	...
	31514 fix_wallet_rpc_ranged_pr31514-29		10c62a07ac8
	...
	31727 miniscript_nonfatal_pr31727-29		2258486a2bd	last=3693e4d6ee0 !hodlinator/2025/04/31727_followup
	...
	31785 fix_gui_rpcconsole_waitfor-29			d41c86fa496
	...
	31958 -										5ccfd70b591	last=32dcec269bf  # rpc: add cli examples, update docs  # docfix_rpc_wallet_cf_psbt-24
	31979 -										75bec77ed0b	last=f708498293c  # torcontrol: Limit reconnect timeout to max seconds and log delay in whole seconds  # tor_backoff_max-26
	# Needs review: 32051 jonatack/2025-03-addnode-p2p
	32073 netinactive_dont_downgrade-26			0534f8009f6
	...
	32176 tor_rnd_stream_isolation-28			693e8ee643c
		# Omitted renaming variable
	# Needs review: 32180 mzumsande/202403_ibd_lastcommonblock
	32185 fix_dbwrapper_batch_header_size-26	8b3828eada1
	...
	# ----- END SEQUENCE -----
	32344 fix_wallet_nonranged_pr32344-22		f1440b35254	last=97d383af6d5
	32351 qafix_nonrecurs_FindChallenges-28		e1674ed2756
		# Fix only
	32355 fix_block_full_enough-29.3			c58e37a7d04
	# Needs review: 32367 hebasto/250428-enable-lang
	-     fix_fs_error_utf8-23					7da6587ffc8
		# Alternative to core#32383 hebasto/250429-fs-error
	32414 fix_reidxcs_periodic-25				c47ef35a58f	last=c1e554d3e58 andrewtoth/reindex-flush
		# Fix only
	...
	32539 fix_rpcallowip_cjdns-29				871b7e219ff	last=12ff4be9c72 pinheadmz/rpcallowip-rfc4193
	...
	# Needs review and simplification? 32636 davidgumberg/5-27-2025-create-refactor
		# + fix from #34490
	32682 fix_wallet_fillpsbt_nothrow-28		ae830c1baec
		# Diff-minimised only
	# Needs review: 32685 -  # wallet: Allow read-only database access for info and dump commands
	32736 fix_listwalletdir_err-23				1c268917232
	...
	32845 fix_rpc_nowallet_errors_pr32845-29	54f2d90a048
	# Needs concept & review: 32869 instagibbs/2025-07-invalid-cb-stall
	32878 fix_index_rewind_badassert_pr32878-19	c940ac1fa00
		# Fix only; left off invasive test
	32987 fix_gui_reindex-29					327e10b43e0
...
TM	33105 cve2025_46598_pt1-29.1                            e6dd6ea13a3
TM	32473 cve2025_46598_pt2-29.1                            ebc912371ec
TM	33050 cve2025_46598_pt3-29.1                            f767d10e674
	...
	33311 log_quiet_pcp_unsupported-29			ceeb363719c
	33338 pcp_interrupt-29						7300e3f3c22
		# Diff-minimised
	...
	g886  wrkrnd_qt_textedit_oom-0.14			38245866fbb
	...
	33464 net_timers_for_inbound_inv-29			89548df4973
NM	33475 fix_block_full_enough_underflow-29+k	034ed2716f8	last=b807dfcdc59 ismaelsadeeq/09-2025-miner-infinite-loop-fix
	33494 urlupd_depends_qrencode-28			a91e4141868	last=93a70a42d30 hebasto/250929-qrencode
	...
	33511 fix_sigint_waitrpcs-29				3c3f9e76254	last=c25a5e670b2 ryanofsky/pr/sigwait
	...
	33580 fix_depends_fallback_filename-0.13	772cc6e535a	last=671b774d1b5 achow101/depends-fallback-name
	...
	33698 fix_qa_rpctimeout_pr33698-27			a3c205b600f
	# Needs review: 33699 0xB10C/2025-10-addr-token-bucket-start-5
	n/a   restore_dnsseed_luke-jr-29.3			90233a099e2
		# Reverts #33723
	...
	# IPC-specific: 33745 Sjors/2025/10/submit-solution-doc
		# +#33880
	g901 fix_qt_rpchistoryfilter_pr_g901-28		3a616a8fcdf
	...
	33813 warn_for_rpcbind_ignored-29			778781674b1	last=335a05c69e1 Ataraxia009/rpc-bind-warning
	# Needs review: 33854 -  # fix assumevalid is ignored during reindex
	# MSVC-specific: 33865 hebasto/251112-plugin-path
	33956 fix_p2pv2_useafterfree_pr33956-26		d03819effe9
	33960 loglevel_corrections-29+knots			72cb3b92c50
		# NOTE: Silently dropped a change somewhat equivalent to #33813 (which is GUI-loud)
	-     loglevel_corrections_bdb-29+knots		60ced5dae6c
	# Triage: IPC-specific: Needs review: 33965 Sjors/2025/11/ipc-reserve
	33993 doc_stopatheight_imprecise-21			b1730078b66
	34028 fix_seenlocal_max-26					9d4c570d9c5	last=2189a6f5f22
	-     fix_feeest_read_rare_overflow-29		0e6b48ac2f0
		# Alternative to: 34109 maflcko/2512-fix-u64
	-     pcp_dont_spam_unauth-29				9d9d8001a9d
	...
	32273 fix_walletmigrate_relpaths-29.3		8938719c2ea
		# NOTE: Held back "wallet: migration: Make backup in walletdir" behaviour change
	34372 qa_wallet_migration_tests_202601-29.3	8bbeb6cb288
		# NOTE: Invisible dependencies on #32273 and #34370
	34176 handle_wallet_dir_nonwritable-29.3	b6aef865b7a	last=08925d5ee75 furszy/2025_wallet_check_db_permissions
		# NOTE: temporarily restored `descriptors=True` in tests until bdb is updated to pass
	-     handle_wallet_dir_nonwritable_bdb-29.3	f40caab8ed0
	31423 wallet_migrate_watchonly_only-29.3	fb5d2312dc2
	...
	k242 fix_bdb_edge_cases_202601-29			269cd3eb074
	k269 wlt_migrfail_cleanup_lognonempty-29.3	2029f024938
	# TODO: consider knots#249 review comments
	# ----- END WALLET DELETION BUGFIXES -----
	34161 fix_distance_ub_pr34161-26			3cec40cdd2d	last=477c5504e05 l0rinc/l0rinc/pool-allocator-ub
	# IPC-specific: Triage: 34184 Sjors:2025/12/cool-down
	# Needs review/work: 34213 brunoerg/2026-01-net-anchors-networkactive
	34224 fix_init_int_ec-27					e5a96af7de9
	34235 fix_miniminer_feeassert_pr34235-26	c0c6135ffc5
	34252 doc_bips_add433-28					922a5171bf4
	-     qt_scope_bringToFront_workaround-28	de99f9828fd
	...
	34293 fix_vermsg_missing_comma-29+knots		b8cbd802403	last=ffd09f8a0d0 fix_vermsg_missing_comma
	34272 fix_psbt_bounds_assert_pr34272-25		1d6bdeb63f4
	# Needs followup work? 34281 maflcko/2601-build-fix-remove
		# 30.x backport in #34283
		# + #34413 (see also issue #34414)
		# + #34468 ?
	34282 qafix_win_log_skips_pr34282-24		54056f16548
	# Duplicate of #29678: 34305 fanquake/fix_space_warning_log
		# Consider CeilDiv from #34436
	34328 monotonic_uptime-29					c6c9b81cbea	last=e67a676df9a !l0rinc/l0rinc/fix-uptime-first-call-zero
		# + #34437
	...
	34369 qa_timeout_factor_netshutdown-29		4f626fe21bc
	...
	g924  fix_qt_restor_empty_walletname_msg-24	608337755c3
	...
	34470 leveldb_wrkrnd_uninit_debugsize-0.8	4ba12192bbf	last=fad7d86d8d1 maflcko/2602-ci-leveldb-ub
...
TM	34561 docfix_rpcwallet_send_eg_pr34561-23	24ac5539e14	last=50cf6838e6a
	# Needs review: 34582 maflcko/2602-int-arg
	34597 fix_SetStdinEcho_ub-0.20				4ee7987e31b
	34603 fix_win_IsSymlink-29.3				e33ef41e09a	last=b127cde3f4a
	# Needs review? 34614 maflcko/2602-ci-space
	g929  qt_plurals_prg929-21					4afca8f6ba1	last=746d8cddc19 hebasto-g/260217-translation-plurals
	# Needs review: 34628 ajtowns/202602-mempool-invtosend
	34642 wallet_validqueue_drainforunload-29.3+knots	17c4da4d51a
	...
	34702 docfix_getblock_txfee_condition-22	ba1ea1b6a75	last=f580cc7e9f2
	...
	34767 fix_qt_intro_chain_except				9e004036ec2
	...
	n/a   fix_typos_from_pr33152-29.3			e6d12926587
	34870 fix_wallet_bump_fail_crash-29.3		264f40f4b2e	last=6072a2a6a1f furszy/2026_feebumper_crash_fix
	# Needs work: 34872 w0xlt/wallet-mixed-input-history-only
	34888 fix_wallet_coinsel_pr34888-25			21bcd69ab79	last=0026b330c4a furszy/2026_wallet_total_amount_bad_comparison
	34893 fix_psbt_merge_proprietary-29			3893a58440d	last=da769855d0c w0xlt/psbt-proprietary-merge-fix
	...
	34937 fix_rlim_infinity-29+knots			c87c8a40b10	last=735b25519aa Sjors/2026/03/file-descriptor-limit
	...
	34959 bdbro_enforce_levels_sizes-28			5af050a4960	last=b2de59d486d achow101/bdbro-cycle-detection
	...
	34988 fix_init_fiasco_pr34988-28			c14824e32e0
	...
	35168 fix_exclude_pruned_from_unlinked-29	d9f72a56cb3
		# Includes test framework addition of create_empty_fork from #32587
	35070 fix_FMWC_ub_pr35070-29				b3c1222eac6
	...
	-     fix_torcontrol_maxlinelen-29+knots	8d3ae74fb9d
		# Includes new tests (only) from #34158
	35087 torcontrol_linelimit-29+knots			2075ad030d3	last=9fe5896a446 davidgumberg/2026-04-14-torcontrol-linelimit
	...
	35116 socks5_redact_authinfo_log-28			4075acc124b
	35117 i2p_redact_privkey_in_log-22			c0e16c350ca	last=b6c36704428 takeshikurosawaa/i2p-session-create-redaction
...
TM	35209 fix_precomptxdata_lifetime_CVE_2024_52911-27	8c3d83d5c4f
	# Needs review: 35217 -  # psbt: fix PSBTInput::Merge ignoring sighash_type field
	35227 fix_bdbro_check_lastpage_pr35227-28	3666d449878	last=e2b0984f995 l0rinc/l0rinc/check-bdb-last-page-lsn
	# Needs review? 35233 l0rinc/l0rinc/external-signer-skip-canceled-duplicates
	35384 fix_settings_writeerror_handling-27	389c14e4455
	-     fix_qt_sync_pct_truncate-28			866706f975a	last=a3dac13371c origin-pull-g/935/head
		# Rewrote from gui#935 to avoid floating point rounding at any stage
	-     fix_rpccookieperms_early				9e93ad7b7e3
	-     qt_intro_nojumpy						c89c7a00245
	-     restore_guix_ppc64le-28				cc4b1fda56c
	-     qt_dialogs_less_modal					b00cf2753a3
	-     docfix_getorphantxs_vsize				524937c6412
		# Originally bundled in Knots with #30793 rpc_getorphantxs
	-     fix_guix_boost_mirror-29				477bdc400ac
	-     fix_qt_startup_unknown_unit			81614a8071e
	-     fix_qt_psbtops_filename_amount		dad76f74ec6
	k126  fix_qt_progressbar_fittext			91f98f04940
	k150  fix_rpc_mixed_params_edgecases		3800876cfe8
	...
	-     qt_nowalletpage_alerts-23				68bff0e8cf3
	-     fix_alertnotify_winquoting			a44004d1499
	-     torcontrol_avoid_bindany_connect		d205e970c2c
	-     fix_tor_common_bind-29.2				930a74cd64c
		# Core duplicate: #34892
	# Needs review: k254 privkeyio/cmake-hardening-module
	# Needs work? k237 privkeyio/159-build-checks
	k244  fix_qt_amtfield_infinityevent			8939dd48798
	-     fix_win_exclopen-29.3					8de480934be
	k255  wlt_nonlegacy_change_if_no_leg_spkman	2ddbebc207f
	...
	k266  extsigner_sanitychk_fingerprint-26	f10fde65577	last=304598b5cc5 privkeyio/fix-external-signer-fingerprint-validation
	k277  fix_qt_ban_expiry_update-28			2117b9573b6	last=87fca974185 Bortlesboat/fix-ban-table-refresh
	# Needs review: k298 param_bounds_checks_202604
	k301 qt_always_show_alerts-27				c70ba017bc0	last=3437824d39b privkeyio/fix-warnings-no-wallet-tabs
	k303 rm_dnsseed_pt							304e9c8f14f
	k329 privkeyio/fix-gen-bitcoin-conf-datadir	231847020e4	last=4f5c53851fa
	k336 qt_locale_datetime_prk336-29+k			a7afad6e384	last=2f53648f1a2 privkeyio/fix-gui-datetime-locale
...
#@29.x-knots-lts-deps
	...
	k345 privkeyio/depends-libevent-2.1.13		3069d050b39	last=0515b85e4f3
	# Needs review: 32655 fanquake/sqlite_3_50_0
	# Needs review: 32665 fanquake/boost_shrink
	-     fix_secp256k1_bugs-29					fd015bb8e98
...
@29.x-knots
# PERFORMANCE:
	33915 qa_getprevrel_retrydownload-28		a7fe2be7faa
	...
	28430 -										b654ad290cc	last=42b25bbd939  # opti_merkle_mutation-0.17
	28592 -										8d6e543379e last=b81f37031c8  # txrelayrate_14txps-26
	...
	29602 opti_IsSpace_pr29602-29+knots			d1ba5dfec67
	# TODO: Revert #29815 ? (ie, use OS provided optimised timingsafe_bcmp)
	30059 dbfilesize_param-29.1					51419739bca	last=c283a572145 dbfilesize_param
	-     dbfilesize_64-29.1+knots				f4528295132
	...
	30611 chainstate_write_hourly-29+knots		3731d2d6657	last=e976bd30450 andrewtoth/write-chainstate-every-hour
	...
	31144 opti_multibyte_xor-29+knots			faa29a6dd60
	31179 -										bfee33471fe	last=5d82d92aff7  # opti_rpc_uv_reserve-25
	31645 opti_dbbatchsize_64-29				dd7541d64ed	last=b6f8c48946c l0rinc/l0rinc/utxo-dump-batching
	...
	32279 opti_script_inline_36b-29				cf6b33deabe	last=d5104cfbaeb l0rinc/l0rinc/prevector-size
	32487 opti_readblock_hash_once-29			e06aa7020b2
	-     netproc_check_blockhash				61c35a3daa4
	...
	32827 opti_removeForBlock_empty-28			7d4a629b58c	last=249889bee6b l0rinc/l0rinc/empty-mempool-IBD
	...
	33332 opti_arith_uint256_trivialcopy-28		bc04da1a765
	33334 opti_blkidx_comparator-26+knots		c3559735019	last=80ac0467ef4 Raimo33/index-work-comparator-branchless
	33410 opti_coinstats_nocopy_pr33410-26		11bac94ad28	last=85d058dc537  # coinstats: avoid unnecessary Coin copy in ApplyHash
	...
	33738 opti_cmpctblocks_nolog_skip_hash-29	08eb8eb4ee8	last=969c840db52 l0rinc/l0rinc/debug-log-serialization
		# Very partial
	...
	34025 cache_time_and_arg_pr34025-29			34c918cb27f
	# Needs review: 34054 sedited/txdownloadman_ibd_check
	# Needs review: 34083 theuni/chacha20-vectorized-initial
	34253 lockless_isibd-26+knots				0e31319d308	last=557b41a38cc l0rinc/l0rinc/cache-ibd-status
	...
	34612 leveldb_slim_pr34612-29				068b84dc17f	last=3feabb203a6 fanquake/unused_historgram
	...
	33333 dbcache_too_high_warning-29.3+knots	f3168b910fb
		# + #33435
	34692 dbcache_1GiB-29.3+knots				49d110defa2	last=4ae9a10ada9 andrewtoth/bump_dbcache
		# Excluded doc update & release notes
	35097 byte_units_64bit_GiB-29.3+knots		0a1d39c7da3
		# Partial; + #34435 (partial)
		# Fixed missing header
	34641 dbcache_dynamic-29.3+knots			e95de03615e
	...
	35195 cache_outpoint_sethash-27				b196f829a10	last=16e77fdf132 l0rinc/l0rinc/noexcept-false
	35197 lld_icf_safe-28						23a1e4f2f7a	last=24ad7419dea fanquake/lld_icf_safe
	...
	35825 privkeyio/net-addconnection-count-guard-core	6201699486e	last=ca7c1456f56
	# Needs review: k278  privkeyio/feature-runtime-scriptcheck-calibration
	k287  privkeyio/uncap-scriptcheck-threads	d2cf7b5f5aa	last=f23f08cb01f
...
# FUNCTIONALITY:
	...
	18479 rpc_sign_show_fees					780931b6c99	last=47b2ba29df2 !origin-pull/12911/head
	...
	15836 fee_histogram+pr15836_api				dcc9c24dd75	last=b94292a7cb jonasschnelli/2019/04/feeinfo
	...
	22693 getaddressinfo_txids					bf45135383f
	g562  wallet_warn_reuse_gui					4eb39c78a4a
		# NOTE: Was #15987
	...
	18972 neutrino_whitelist-mini				4485016286c	last=a0d0807abc2 neutrino_whitelist
		# NOTE: Diff-minimised
	# Needs work/review AND CONCEPT ACK: 17950 emilengler:2020-01-password-strength-checker
	-     qt_openuri_pastebtn_shortcut-23		cf720d09838
	...
	18014 siphash_optimise_pr18014-27+knots		79447834cfa	last=409c2e34522 elichai/2020-01-siphash
	...
	24202 rpc_dumptxoutset_hr-29+knots			f8d3a09ffe3	last=1053636ddd9
	...
	19873 mempressure-29+knots					eb464ac8938	last=5b43cc77824 mempressure
	...
	g291  gui_trafficgraph_vert-0.21			67ce7075a7d	last=500841e49d6  # Enlarge Network Traffic Graph
		# WAS gui#90
	...
	20391 rpc_setfeerate-28+knots				34fc0492a5b	last=1002e2d0d7f jonatack/setfeerate
	...
	20407 rpcauthfile-29+knots					61bff538060	last=ff5d7fa1e4c promag/2020-11-rpcauthfile
	...
	g149  intro_assumevalid						a1aa92ea0df	last=cf940f0e5f5
		# NOTE: Added compatibility for older Qt versions
	# Needs review: 20652 -  # Designer fees when coin control is enabled
	20702 rpc_getblocklocations					6a978b5b316	last=9b03c654eb3
	...
	g363  qt_peers_directionarrow-25+knots		c049a24a6d8	last=727a2f83cca qt_peers_directionarrow
	...
	21928 rpc_hww_toggle-25						52e774bac02	last=1af20831806 Sjors/2021/05/hww-toggle
	...
	# TODO: 21283 achow101/psbt2
		# TODO: diff-minimise??
	21260 rpcwallet_tx_in_mempool-29+knots		a7218b4dbcf	last=46bf0b7b5d8
	...
	22072 autoreindex-29+knots					0042ee4e130	last=602f4da9178
	...
	g307  gui_peers_rowcolouropt				664887a3ffc	last=fdf80937d1c hebasto-g/210501-stripes
	...
	22372 multinotify							64cc496ddf9
	24963 rpc_walletprocesspsbt_options-26		1d530b97f2e	last=40143bafb52 rpc_walletprocesspsbt_options
	...
	-     rpc_descriptorprocesspsbt_opts		7f3e8b68c37
	...
	23362 importfromcoldcard					77a000763c4	last=8076f8d4c2a hebasto/211025-cc
	...
	23387 rpc_savefeeestimates-29+knots			24fbdc73438	last=d5b41e6b2ed greenaddress/dump_fee_estimates  # savefeeestimates
	...
	g473  rebroad-g/NonLinearTraffic			a16a52a5876	last=ad431ff5d18
		# TODO? change to logarithmic scale? 8398d247f4e
	# Needs work: g484 rebroad-g/RetainNetworkGraphOnIntervalChange
	g492  qt_traffic_tooltip					52737be2e83	last=6c139ebf710 rebroad-g/NetworkGraphTooltip
	...
	g820  qt_fontsel_qrcodes-27+knots			b76163a2bdb	last=b14c9d0572e qt_fontsel_qrcodes
	# TODO: qt_fontsel_console
	# Needs review: 24007 -  # [mempool] allow tx replacement by smaller witness
	-     verifymsg_bip137_and_electrum			75a20ab78c1
		# NOTE: Fully reverts gui#819 in anticipation of #24058
	24058 bip322-29+knots						141e60581f5	last=29b28d07fa9 kallewoof/202201-bip322
	...
	24162 rpc_deriveaddr_wo_checksum-29			7b2b7a557f2	last=97a69e232be
		# +RPC doc fix
	...
	25183 rpc_fundraw_segwitonly				cd5b38a4b5a	last=9e7fd5c0fe3
	...
	-     whitelist_outgoing_auto				6c3cc02689a
	# Needs work: 26441 brunoerg/2022-10-whitelist-rpc
		# CAUTION: neutrino whitelisting interaction
	27446 benthecarman/configure-signet-blockitme	1f3d66bb69a	last=d8434da3c14
	...
	26576 rpc_disconnectnode_subnet				a47d156aecd	last=23f4c2cb452 brunoerg/2022-11-disconnectnode-subnet
	...
	27034 rpc_importaddr_for_descwallet-27+k	fd02b0a0b60	last=be3ae51ece8 furszy/2022_rpc_importaddress_descriptors_compatible
		# Diff-minimised & tweaked to avoid breaking #23362
	27052 rpc_getpeerinfo_lastblockann-28		21c6cd617b1	last=13ce46ba1a7 LarryRuane/2023-02-getpeerinfo
	...
	27216 rpc_getaddressinfo_isactive			fd87fe51489	last=85f83339dda pinheadmz/used-addr-ui
	# Needs work: 27260 -  # Enhanced error messages for invalid network prefix during address parsing.
	27351 codex32-29+knots						c2fa34a8155	last=91771366a3d apoelstra/2023-03--codex32
		# + knots#267
	...
	27600 p2p_forceinbound-28+knots				3f640e277a4	last=8c2026848da pinheadmz/whitebind-evict
	...
	27770 rpc_getblockfileinfo-28+knots			1a2017cc739	last=5090771f326 furszy/2023_rpc_getblockfileinfo
	...
	29016 rpc_listmempooltxs-29+knots			142fd179c04	last=07008477b81 niftynei/nifty/listmempoolentry
	...
	-     manpages_seealso_notself				c379cfe1a09
	...
	30635 rpc_waitfornewblock_tip_param-29+k	1124fc7d222	last=c6e2c31c551 Sjors/2024/08/waitforblock
	# Needs review: 30685 hebasto/240820-control-flow
	30713 -										2c346f9512d	last=5b2d0216d87  # rpc_scanblocks_status_results-28
	...
	30860 bashcomp_bcli_generate-29				a505f5b2fd7	last=abf6ad42bdb BrandonOdiwuor/bash-completion
		# Bugfix + Left off re-generation until later
	k190  feat_zsh_completion-29				141db520de9	last=e3f6d308a97  # Add zsh completion script generation support
	...
	30886 rpc_descrprocesspsbt_prevtxs-28+knots	95c8e3d338c	last=87ceb610a72 instagibbs/2024-09-updateutxo_psbt
	...
	31560 rpc_dumptxoutset_fifo-29+knots		d69047598dd	last=b19caeea098 theStack/202412-dumptxoutset-allow_write_to_named_pipe
	...
	31672 peer_cpu_load-29+knots				324aca44063	last=52f1efc06af vasild/peer_cpu_load
	31845 pruneduringinit-29+knots				f08f02832e8	last=d4a3abf6d43 pruneduringinit
		# TODO: + knots#158 ?
	31886 netinfo_local_svcs-29+knots			29b858f03be	last=721a051320f jonatack/2025-02-netinfo-services
	# Needs work: 31936 -  # rpc: Support v3 raw transactions creation
	31953 bumpfee_full_rbf-29+knots				28ddfe50d75	last=fa86190e6ed maflcko/2502-fullrbf-follow-up
		# Was: 26454 petertodd/2022-feebump-without-optin
		# NOTE: Added warning to GUI and made RPC behaviour change optional
	32200 socks_tor_error_codes-0.18			e1b25bd09f2
	# Needs work? 32297 ryanofsky/pr/ipc-cli
	32423 hash_rpcuserpass-29+knots				ac25ee7e5d1	last=e49a7274a21 laanwj/2025-05-remove-rpcpassword-deprecation
		# Left out refactoring
	32425 proxy_per_net-29						9315debd7a6	last=e98c51fcce9 vasild/proxy_per_network
		# Left out doc updates/reformatting
	32429 doc_rpc_keypoolrefill_pr32429-23		0e53efc243f
	...
	32540 rest_spenttxouts-26					084c1e4aa39
		# +32842
	...
	32844 rpc_gettxoutproof_segwit-27+knots		c217726fc4c	last=23edd3db4f1 rpc_gettxoutproof_segwit
	...
	33004 def_natpmp_true-29					7f3dbbf42aa
	...
	33230 rpc_cli_hashorheight-29				ad3c1edeb55	last=df67bb6fd84 achow101/cli-strong-or-json
	...
	33414 tor_pow-29+knots						d7f642a2bc1
	...
	34776 guix_clean_confirm-22					5c1a7f8abe9	last=2724c392080 !origin-pull/34800/head^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
	...
	35076 doc_pruning_impact_pr35076-24			a1b4cc07858	last=51ee8ca1683
	...
	-     qt_createunsigned_use_psbtops			8a9d19ddef2
...
# Non-progress functionality:
	8751  sort-multisigs-28+knots				4739e0dbe8e	last=e11cb50a09  # multisig sorting
		# held back 50e2ff58f2..e11cb50a09 which turned options into a boolean directly
	22016 rpc_gbci_period_start					02f37bd42a4	last=1898b9be12c Sjors/2021/05/versionbits_period_start
	9152 sweepprivkeys-29+knots					7bd7baf55f7
	...
	9245 ionice-29+knots						8871a49ce00
		# low prio: p2p requests, loading/verifying blocks on disk
		# normal prio: connecting blocks, indexes, user requests
	-    ionice_win-29+knots					7d78de31c23
	8501  old_stats_rpc-29						8a4e7f3123a	last=7af0ea43b2
	...
	10615 multiwallet_rpc-29+knots				0458e94fedd  # latest code now
	...
	10350 filtered_witblock-28				0c158812939	last=3f388ddcd3 CodeShark/MFWB_no_bump_2
	...
	11750 coincontrol_multiselect				510285f9e7d	last=7cec76f81b # Multiselect in coincontrol treewidget and display selected count
		# NOTE: deviated from PR
	11770 rest_fee								483d92d9662	last=eff1b3e201  # [REST] add a rest endpoint for estimatesmartfee, docs, and test
	...
	11803 bugfix_dumpwallet_hdkeypath			ef1c34b1ced
	12965 scriptthreads-29+knots				efc78b25154	last=dfab6c6866 jonasschnelli/2018/04/svt
	13203 dsha256_power8-29						b18761f3c5e	last=3b402e0738 TheBlueMatt/2018-05-asm
		# NOTE: Stripped out benchmark change
		#29.xTODO# Watch for Makefile.am or other changes for shared libbitcoinkernel on Windows
	15218 postibd_flush-28						fc20c20554f	last=8887d28a014  andrewtoth/flush-after-ibd
	15428 tor_gui_pairing-29+knots				6740f6876ab	last=ab9ed21dc98 tor_gui_pairing-0.21+knots
		# Implicitly relies on gui#506 for QR Code without text being centred (dropped buggy 4a881554991)
	15421 tor_subprocess-29+knots				5db14a0f2d7	# Latest code now
		# + knots#352
	...
	17795 gui_console_ctrl_d-26+knots			eaeff7a10e1
		# NOTE: Completely rewrote to work on all platforms, in addition to Ctrl-W
	15861 restore_vbits_warning					3cb96fab474
	n/a   rpc_compat_error_index-25+knots		c7c288ebda5
		# Compatibility with 0.19.0-0.21.0 bech32_error_detection
	g537  gui_bech32_errpos						2cc5f13389c
	17636 guisettings-0.21						a59f6db7849	last=187f9684e03 emilengler/2019-11-guisettings
		# Held back 5266efa964b..187f9684e03 (too strict error checking?)
		# (and removed release notes)
	17958 rpc_getgeneralinfo					1abbac789fc	last=cdbd38df131  # getgeneralinfo RPC
	18223 blockfilter_v0						bcf60ce76bc	last=5561e7a0c79
		# NOTE: Don't enable with -blockfilterindex=1
		# NOTE: Diff-minimised
	19089 cli_getinfo_mwbalances-29				c567dc5f57c	last=865d2c32d5a jonatack/cli-getinfo-multiwallet-follow-ups
	19092 cli_getinfo_mw_total_balance-29+knots	a32f0bb43cf	last=08ac1abc583 jonatack/cli-getinfo-multiwallet-total-balance
	(CHECK-LAST)	last=71bfa1fb715 cli_getinfo_mw_total_balance-26
	19117 rpc_getrpcwhitelist					a71d89d5e19
		# NOTE: Was #18827 before any Knots merge
	-     getrpcwhitelist_wallets-29+knots		d284873571d
		# NOTE: when #19118..#19120 get merged, add 71294ee9799
	# Needs purpose: 21815 prayank23:max-out-full-relay
	-     wallettool_dump_warning-29+knots		510410069ac
	...
	-     font_for_money_global					696f1ef0914
	k157  qt_darkmode-29+knots					6b22fca9f93	last=2c15a2071f6 bigshiny90/v29.1-knots-rc1-guifixes
...
# Non-upstreamed functionality:
	-     rm_tarball_ci-29+knots				a725d72ad6c
	# TODO: Revert #25898 ? (Dropped WSL1 compatibility)
	-     restore_upnp-29.3+knots				9cbc72889d4
	...
	n/a   restore_feefilter_opt					4d0e5b4a06b
	-     gui_payreq_textedit					2e3e08ff276
	(CHECK-LAST)	last=cad6d027fd7 origin-pull-k/332/head
		# Includes knots#332
	# NOTE: Restoring BIP70 would require restoring OpenSSL, protobuf, and Qt's OpenSSL support :(
	-     rpc_mempoolentry_txhash				db5525c661e
	# FIXME: -     walletnotify_w_win-27+knots			c892f8b6dbf	# Latest code now
		# FIXME: this is broken :(
NM	14137 win_taskbar_progress					99a83c92857	last=18eb4dbb8a
		# Replaced with:
	k215  win_taskbar_progress_com-29			70b44bb6328	last=5f4e34a556d kwsantiago/kwsantiago/191-win-taskbar-progress-qt6
	-     restore_blockmaxsize					066eeacab6c
		# TODO?? blockreservedsize option
	#30.xTODO# Revert #32654 (deprecate blockmaxweight)
	7107  qtnetworkport-29.1+knots				7c7cd8973de	last=1f37c87d8f2 origin-pull/7107/head
		# FIXME: Unbind IPv6 on the other port, if its IPv4 bind failed
	7533  sendraw_force-29.2+knots				47c4a22b5d3 last=2627c0937f8 sendraw_force
	...
	11082 rwconf-29+knots						651ff40f4d6 # Latest code now
		#30.xTODO# Squash fixes
		#30.xTODO# Deprecate with settings.json better?
	7510  rwconf_gui-29.1+knots					13b64466ded
		#30.xTODO# Squash fixes
	...
	559   accept_nonstdtxn						06615359f42
		#30.xTODO# Revert or redefine #29843 if it got merged
	929   tbc									2d7ed597b2f
	n/a   tbc_font								93e384cc632
		# Includes ff7b90dc729 Embedded font: Rename to avoid confusion in font selector  (fix_qt_fontsel_confusion)
	 553 bugfix_qt_uri_amount_parser			00ebf642112
	5861 gui_restore_addresses					bece813f409
	5891  qt_console_history_persist			5112adefe69	last=2e1d9cb3466 qt_console_history_persist
	(CHECK-LAST)	last=6a5537ab675 origin-pull-k/203/head
		# Includes knots#203 (Add migratewallet RPC in historyFilter)
	k214 qt_console_clearhistory-29+knots		d962e9e8e5b	last=d6ded3f4441 kwsantiago/kwsantiago/204-clearhistory
	-     net_identify_librerelay				b0e4b2a6d2f
	-     net_identify_utreexo					aafce68cc1d
	-     net_identify_rdts						c4e8a4fca4a
	# TODO? petertodd has a branch with 4 extra outgoing peers requiring RBF service flag
	# TODO: some way to add UA comments via rwconf
	12146 opt_wallet_segwit2					771e06ed411
	...
	-     gui_wallet_displayname_wo_dat			d07ab5324bb	# Latest code now
	-     gui_request_payment_label-0.19		98e9617aa37
	-     gui_peers_sort_network-23				f10744ef95e
	-     gui_peers_no_net_column				47fc928fc6e
	...
	-     rpc_getblockfrompeer_future			948e5cc6759
		# Revert of #23927
	-     rpc_getblockfrompeer_wo_header		cf024d806d1
	...
	32547 mining_avoid_block_copy-29+knots		138c1cd131f	last=7d05ec01d4e mining_avoid_block_copy
	-     gbt_rpc_options-29+knots				102eca897b4
	...
	-     blockview-29+knots					bb8774dc829
	...
	-     restore_libconsensus					57165655308
	...
	-     rpccookieperms_log_improvements-29+k	21dc1950408
	...
	33023 qa_cb_extratxs-25						4f64b2af25d	last=841b3c2e966 bigshiny90/compactblocks-extratxs-tests-core
		# Held back f9c6331cb26...841b3c2e966 for now
	#30.xTODO# Revert #32450 ?
	#30.xTODO# Revert #32510 or replace extratxn pool
	k171  Raimo33/add-dockerfile				4f1977f9fb6	last=4b778a21835
	k187  Retropex/dnsseed-leo					983d7d6e2bc	last=68abc8a3262
	...
	k262  index_prune_error_suggestion-29		c46afca58e4	last=08574e0aa23 privkeyio/fix/87-blockfilterindex-pruning-startup
	...
	k288  qt_syncprogressbar_fullwidth-0.7		b3ab1ae3283	last=45e89eed5b9 SpectrGen1/issue-177-better-progress-bar
	k297  qt_sweepprivkeys-29					8fbe9887063	last=2e165cdffc5 privkeyio/gui-sweep-privkey
# Non-upstreamed policy options (default off):
	30232 refactor_isstandardtx_mpopts-29+knots	afe98bce374
	-     pol_acceptunknownwitness				7ff5261ebd5
	-     mining_priority						a658f6147ea	# Latest code now
	...
	7219  rbf_opts-29+knots						679fbd8d82b	# Latest code now
	-     truc_opts-29.2+knots					799eefa2ac1
	#TODO/Needs work: 10823 greenaddress/replace-by-fee-old-transactions
	29309 permitbarepubkey-29+knots				12182d1cc17	last=1dfe27e49ab
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
	-     bytespersigopstrict-29+knots			0b9e5fef7e5
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
	9749  unique_spk_mempool-29.2+knots			affdf917142
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
	-     dustdynamic-29.1+knots				dbbbdd1c2d0
	# ---- BEGIN DATACARRIER ---- (OLGA not backported)
	28408 match_more_datacarrier-29+knots		14c02a81737	last=4d2ec0671a3 match_more_datacarrier
	...
	# ---- END DATACARRIER ----
	k136  pol_permitephemeral					01a5d4fc912
	...
	-     maxscriptsize-29+knots				e6fdf519e75
		#30.xTODO# TODO: Add to getmempoolinfo like #29954 (see b02aab950af)
		# Alternate to(?) #29769
	...
	k148  minrelaymaturity-29.1+knots			47a671b8643
	...
	-     pol_maxtxlegacysigops-29.1+knots		f33222ff033
		# Made user-configurable and overridable
	-     blockreconstructionextratxnsize		d8590301280
	...
	k162  qt_bad_external_signer_msg-22			2c69b923416	last=111c401fc5a bigshiny90/fix-invalid-scriptsigner-errordialog
	# Needs work: k271  privkeyio/policy-tapscript-dust-limit
	k272  subdustfeepenalty-29.3+knots			3fec01629b8	last=af7d6f6adba privkeyio/policy-subdust-fee-penalty
	...
	k292  datacarrier_opnet-29+knots			e9294b92ccb	last=6938c68fe68 Retropex/rework-opnet
...
# Non-upstreamed Knots compatibility:
	...
	-     compat_rpc_dumptxoutset_hr			9b773913039
		# FIXME: 'type' param attempts to parse as JSON ? (with 28.x bitcoin-cli tho)
		# FIXME: 'rollback' param rejects height ?
	-     compat_jsonrpc_weirdversions			67f0d9de2fd
	29530 rpc_getpeerinfo_misbehaving_score-29+k	925e9e60348	last=87efb6f0cfd
	...
	-     rpccookieperms_octal_compat-29+knots	d00dff07c05
	-     zmq_ipc_uri_compat					7478df465b6	last=0b1762c90d1 origin-pull/28020/head
	...
	-     wallet_undeprecate_legacy-29			a68909e8a5c
	...
	14641 fundraw_min_conf_deprecated-25+knots	4128c88a25d	last=55a0b4c0f90 promag/2018-11-fundrawtransaction
	-    preserve_unsupported_keyflags			25f5e9295f1
	-     netperms_implicit_addr				be564c7458c
	-     rpc_getblockfrompeer_nodeid_compat	ed1b8303203
	# TODO: add a bitcoinknots.conf ?
	n/a   gui_peers_bump_setting_keys-29+k		56929e915a5
...
# POLICY:
	-    1day_default_conftarget				940e1097022
	...
	-     def_bloom_local_only					1923831c651
		# NOTE: Includes typo fix
	-     wallet_avoid_newerchange				6e09971fc01
	-     enforce_checkpoints					1b4be6e269c
		#30.xTODO# Revert #31649
	n/a   checkpoint_update-29					0e304613bd4
	...
	# TODO: revert #28354 ?
	10282 softwareexpiry						d7c3fd7d9e2
	...
	-     rwconf_policy-29.3+knots				a3c8cb51abe
		# + knots#245
...
# HARDFORK:
	...
	k359  pow_hf_blake2b
	k357  sighash_unified-29.3+knots						last=54d757f269d privkeyio/hf-sighash-opt-in
		# TODO: Needs review?
	...
	k368  blake2b_servicebit-29+knots						last=e9f3af467e2 chrisguida/blake2b-servicebit-29+knots
		# TODO: Needs review?
	k386  blake2b_rapid_dns-29+knots						last=f4004d5fcf9 privkeyio/blake2b-dns-immediate-when-no-hf
		# + tidy fix
...
# Pre-BRANDING: (might need to be part of F patch to eliminate binary files)
	...
	7483  svg_icon-29.3+knots					343d8f3c83a
	(CHECK-LAST)	last=c198e9b3586 origin-pull-k/328/head
		# Consider: https://github.com/bitcoinknots/bitcoin/pull/54
		# Includes knots#328
# BRANDING:
	n/a   upd_copyrightyear-29					ce5c4a70a97
	n/a   font_ocrbitcoin						a753965276c
	n/a   knots_branding-29						085b3cd56d5
...
#	n/a  knots_historical_relnotes				61100a2
	...
	n/a   (cherrypick=b9682b0a548)				40c268945fc  # release notes: write/update, including change log and credits
	...
	n/a  (cherrypick=8c85b1585da)				2d531eaf4b0  # update manpages (build first)
